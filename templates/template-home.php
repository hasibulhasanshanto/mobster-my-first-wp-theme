      ...
      <div class="col-lg-10">
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="card card-body border-0 text-center shadow pt-5">
              <div class="svg-icon mx-auto mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/customizable.png" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInRight">
            <div class="card card-body border-0 text-center shadow pt-5">
              <div class="svg-icon mx-auto mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/concept.png" alt="">
              </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 wow fadeIn">
        <div class="img-place">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/app_preview_4.png" alt="">
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="owl-carousel stack-carousel mt-5 wow fadeInUp">
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/person/person_1.png" alt="">
          </div>
      ...
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/person/person_2.png" alt="">
          </div>
          <div class="avatar-caption">
            <p class="mb-0 fw-medium fg-primary">Galih Raugana</p>
      ...
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/person/person_3.png" alt="">
          </div>
          <div class="avatar-caption">
            <p class="mb-0 fw-medium fg-primary">Galih Raugana</p>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center align-items-center mt-5">
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/clients/alter_sport.png" alt="">
        </div>
      </div>
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
